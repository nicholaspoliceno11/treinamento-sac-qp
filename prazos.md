...
*   **Intermunicipais MS:** Até **6 horas** antes do embarque[cite: 2].
*   **Interestaduais (Regra Geral):** Até **3 horas** antes do embarque[cite: 2].
...
| :--- | :--- | :--- |
| **Pix** | Até 2 horas para compensar[cite: 2]. | **Imediato (Até 30 minutos)** via sistema (limite de 90 dias)[cite: 2]. |
| **Transferência** | Até 4 horas para compensar[cite: 2]. | **1 a 3 dias úteis** diretamente na conta de origem[cite: 2]. |
| **Cartão de Crédito** | Até 24 horas (sujeito ao Antifraude)[cite: 2]. | **1 a 2 faturas** (depende da bandeira). PagSeguro: 30 a 60 dias[cite: 2]. |
| **Boleto Bancário** | 1 a 3 dias úteis (intervenção bloqueada)[cite: 2]. | **Até 5 dias úteis** (Processo manual via formulário do titular)[cite: 2]. |
