...
*   **Viagens Interestaduais (Entre estados):** Solicitação permitida até **3 horas** antes da partida[cite: 1].
*   **Viagens Intermunicipais (Dentro do mesmo estado):**
    *   **São Paulo (SP) e Paraná (PR):** Até **8 horas** antes do embarque[cite: 1].
...
3. **Remarcação Fora do Prazo (Garantia ANTT):** Para trajetos interestaduais vencidos, informe ao cliente que ele pode realizar a remarcação diretamente no guichê da viação por até 1 ano, estando sujeito a uma multa de até 20% do valor da passagem[cite: 1].
4. **Viações Restritas:** As empresas **Progresso, Cruzeiro e Transaquino** não permitem procedimentos online. O cliente deve tratar diretamente com os canais delas[cite: 1].
